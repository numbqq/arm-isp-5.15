 ...
 * Description:
 */
#ifndef __IMX415_API_H__
#define __IMX415_API_H__
...
void cmos_get_sensor_ae_roi_imx415(int ViPipe, void* ae_roi);
void cmos_set_sensor_entity_imx415(struct media_entity * sensor_ent, int wdr);
void cmos_set_sensor_ae_roi_imx415(int ViPipe, struct sensorConfig *cfg, uint64_t ae_roi);
