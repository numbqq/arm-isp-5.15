...
typedef enum
{
    ...
    AML_MBI_ISP_QueryWBObj,
    AML_MBI_ISP_AWBRegionAttr,
    AML_MBI_ISP_CfgAlgFps,
    AISP_3A_MAX,

    AML_MBI_ISP_SaturationAttr = 80,
    ...
    AML_MBI_ISP_IspSharpenAttr = 120,
