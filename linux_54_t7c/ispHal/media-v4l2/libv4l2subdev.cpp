...
int v4l2_subdev_set_wdr(struct media_entity *entity, uint32_t wdr_mode)
{
    ...
    ext_control.id = V4L2_CID_AML_MODE;
    ext_control.value = wdr_mode;
...
const char *v4l2_subdev_pixelcode_to_string(unsigned int pixelcode)
{
    unsigned int i;
    enum v4l2_mbus_pixelcode  code = (enum v4l2_mbus_pixelcode )pixelcode;
